...
import kotlinx.coroutines.launch
     ...
     */
    internal fun PaintViewModel.thumbFor(layerIndex: Int, layerName: String): Bitmap? {
    ...
    internal fun PaintViewModel.renameLayer(i: Int, name: String) {
    ...
    internal fun PaintViewModel.setLayerOpacity(i: Int, v: Double) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setLayerLocked(i: Int, locked: Boolean) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setLayerAlphaLocked(i: Int, locked: Boolean) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setLayerColorLabel(i: Int, label: Int) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setLayerClipped(i: Int, clipped: Boolean) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setBackgroundColor(color: Int, commit: Boolean = true) {
        if (commit) {
            runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.moveLayer(from: Int, to: Int) {
        runCore(after = ::notifyLayerChanged) {
            ReverieCoreBridge.moveLayer(from, to)
        }
    }

    internal fun PaintViewModel.moveLayerAbove(from: Int, above: Int) {
        runCore(after = ::notifyLayerChanged) {
            ReverieCoreBridge.moveLayerAbove(from, above)
        }
    }

    internal fun PaintViewModel.moveLayerToGroup(from: Int, group: Int) {
        runCore(after = ::notifyLayerChanged) {
            ReverieCoreBridge.moveLayerToGroup(from, group)
        }
    }

    internal fun PaintViewModel.moveLayerRelative(from: Int, target: Int, placeAbove: Boolean) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.addMaskToLayer(layerIndex: Int, maskType: Int) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.setGroupPassThrough(i: Int, passThrough: Boolean) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.applyFilter(i: Int, filterId: Int) {
        runCore(after = ::notifyLayerChanged) {
    ...
    internal fun PaintViewModel.addLayerWithType(name: String = "", type: Int = 0, fillColor: Int = 0xFFFFFFFF.toInt()) {
        runCore(after = ::notifyLayerChanged) {
